                ...
                <div className="flex w-full items-center gap-2 sm:w-auto">
                  ...
                  {u.id !== viewerId && (
                    <button
                      ...
                      onClick={() => kick(u)}
                      className="inline-flex size-9 shrink-0 items-center justify-center rounded-md text-[var(--destructive)] transition-colors hover:bg-[color-mix(in_oklch,var(--destructive),transparent_85%)] disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      {kicking === u.id ? (
